        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GuardianRelationships_AspNetUsers_ChildId",
                        column: x => x.ChildId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GuardianRelationships_AspNetUsers_GuardianId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceModel = table.Column<int>(type: "int", nullable: false),
                    Price = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                    EstimatedHours = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: false),
                    ...
                    DeadlineDays = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobListings_AspNetUsers_AssignedToId",
                        column: x => x.AssignedToId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JobListings_AspNetUsers_ListerId",
                        column: x => x.ListerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JobListings_JobCategories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    GuardianApprovedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    GuardianApprovedById = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobApplications_AspNetUsers_GuardianApprovedById",
                        column: x => x.GuardianApprovedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobImages_JobListings_JobListingId",
                        column: x => x.JobListingId,
                        principalTable: "JobListings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Messages_JobListings_JobListingId",
                        column: x => x.JobListingId,
                        principalTable: "JobListings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_JobListings_JobListingId",
                        column: x => x.JobListingId,
                        principalTable: "JobListings",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ratings_AspNetUsers_FromId",
                        column: x => x.FromId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Ratings_AspNetUsers_ToId",
                        column: x => x.ToId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Ratings_JobListings_JobListingId",
                        column: x => x.JobListingId,
                        principalTable: "JobListings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OverLimit = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkTimeLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkTimeLogs_AspNetUsers_WorkerId",
                        column: x => x.WorkerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WorkTimeLogs_JobListings_JobListingId",
                        column: x => x.JobListingId,
                        principalTable: "JobListings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GuardianRelationships_ChildId",
                table: "GuardianRelationships",
                column: "ChildId");

            migrationBuilder.CreateIndex(
                name: "IX_GuardianRelationships_GuardianId_ChildId",
                table: "GuardianRelationships",
                columns: new[] { "GuardianId", "ChildId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_JobApplications_GuardianApprovedById",
                table: "JobApplications",
                column: "GuardianApprovedById");

            migrationBuilder.CreateIndex(
                name: "IX_JobApplications_JobListingId_WorkerId",
                table: "JobApplications",
                columns: new[] { "JobListingId", "WorkerId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobImages_JobListingId",
                table: "JobImages",
                column: "JobListingId");

            migrationBuilder.CreateIndex(
                name: "IX_JobListings_AssignedToId",
                table: "JobListings",
                column: "AssignedToId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobListings_ListerId",
                table: "JobListings",
                column: "ListerId");

            migrationBuilder.CreateIndex(
                name: "IX_JobListings_Status_CategoryId_PostalCode",
                table: "JobListings",
                columns: new[] { "Status", "CategoryId", "PostalCode" });

            migrationBuilder.CreateIndex(
                name: "IX_Messages_JobListingId_CreatedAt",
                table: "Messages",
                columns: new[] { "JobListingId", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ratings_JobListingId_FromId",
                table: "Ratings",
                columns: new[] { "JobListingId", "FromId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Ratings_ToId_CreatedAt",
                table: "Ratings",
                columns: new[] { "ToId", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkTimeLogs_JobListingId",
                table: "WorkTimeLogs",
                column: "JobListingId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkTimeLogs_WorkerId",
                table: "WorkTimeLogs",
                column: "WorkerId");
        }
